...
export default function HomeScreen({ Navigation }) {
    ...
    const onItemPressHandler = (selectedItem) => {
        const selectedItemCategory = listItems.length > 0 ? listItems.filter(e => e.include(selectedItem.Category)) : null;
        console.log(selectedItemCategory);
        Navigation.navigate("ItemDetails", { selectedItem, selectedItemCategory })
